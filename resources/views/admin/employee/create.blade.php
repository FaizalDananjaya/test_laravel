        ...
        <div class="col-sm-12 col-xl-7">
            <div class="bg-secondary rounded h-100 p-4">
                <div class="mb-4 d-flex">
                    ...
                    <h6 class="my-2 mx-3">Tambah Karyawan</h6>
                </div>
                <form method="POST" action="/formulir/employees" enctype="multipart/form-data">
                    @csrf
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" id="nama" autocomplete="off" value="{{ old('nama') }}" placeholder="botak lebih indah">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control bg-dark @error('no_telp') is-invalid @enderror" name="no_telp" id="no_telp" value="{{ old('no_telp') }}" autocomplete="off" placeholder="botak-lebih-indah">
                    ...
                    <div class="form-floating mb-3">
                        <input type="email" class="form-control bg-dark @error('email') is-invalid @enderror" name="email" id="email" value="{{ old('email') }}" autocomplete="off" placeholder="botak-lebih-indah">
                    ...
                    <div class="form-floating mb-3">
                        <textarea class="form-control" name="alamat" placeholder="Estimasi waktu 10 menit perawatan" id="alamat" style="height: 150px;">{{ old('alamat') }}</textarea>
