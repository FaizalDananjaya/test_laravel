        ...
        <div class="col-sm-12 col-xl-7">
            <div class="bg-secondary rounded h-100 p-4">
                ...
                <form method="POST" action="/kirimpesans" enctype="multipart/form-data">
                    @csrf
                    <h6 class="mb-4">Kirim Pesan ke Semua Subscriber</h6>
                    <input type="hidden" name="employee_id" value="{{ auth()->user()->employee_id }}">

                    <div class="form-floating mb-3">
                        <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" id="title" placeholder="Potong Cepak" value="{{ old('title') }}" autocomplete="off" required>
                    ...
                    <div class="form-floating">
                        <textarea class="form-control @error('body') is-invalid @enderror" placeholder="Estimasi waktu 10 menit perawatan" name="body" id="body" style="height: 150px;" value="{{ old('body') }}" required></textarea>
