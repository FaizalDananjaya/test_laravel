    ...
    <div class="row g-4">
        ...
        <div class="col-sm-12 col-xl-7">
            ...
            <div class="bg-secondary rounded h-100 p-4">
                ...
                <form method="POST" action="/formulir/blogs/{{ $post->slug }}" enctype="multipart/form-data">
                    @method('put')
                    @csrf
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" id="title" autocomplete="off" value="{{ old('title', $post->title) }}" placeholder="botak lebih indah">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control bg-dark @error('slug') is-invalid @enderror" name="slug" id="slug" value="{{ old('slug', $post->slug) }}" autocomplete="off" placeholder="botak-lebih-indah">
                    ...
                    <div class="mb-3">
                        ...
                        @endif
                        <input class="form-control bg-dark @error('image') is-invalid @enderror" type="file" name="image" id="image" accept="image/*" onchange="previewImage()">
                        @error('image')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
