            ...
            <div class="bg-secondary rounded p-4">
                ...
                <div class="col-sm-12 col-xl-10 justify-content-center">
                    ...
                    <article>
                        ...
                        <header class="mb-3">
                            <!-- product title-->
                            <h1 class="fw-bolder mb-1">Product : {{ $product->name }}</h1>
                            <!-- product meta content-->
                            <div class="text-muted fst-italic mb-2">Category : {{ $product->category->name }}</div>
                            <!-- product categories-->
                        ...
                        <div class="gambar-all">
                            ...
                            <div class="gall-ser mb-3">
                                ...
                                <div class="overlay">
                                    <form action="/formulir/image_products/{{ $image->id }}" method="post" class="d-inline">
