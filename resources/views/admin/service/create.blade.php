    ...
    <div class="row g-4">
        ...
        <div class="col-sm-12 col-xl-7">
            <div class="bg-secondary rounded h-100 p-4">
                ...
                <form method="POST" action="/formulir/services" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-floating mb-3">
                        <textarea class="form-control" name="desc" placeholder="Estimasi waktu 10 menit perawatan" id="desc" style="height: 150px;">{{ old('desc') }}</textarea>
        ...
        <div class="col-sm-12 col-xl-5">
            <div class="bg-secondary rounded h-100 p-4">
                ...
                <div class="form-floating mb-3">
                    <h6>Gambar</h6>
                    <p>Gambar merupakan thumbnail dari setiap post <br>Ukuran file gambar tidak boleh melebihi 1 MB <br>Gambar bersifat opsional atau memiliki ukuran 400x400px</p>
                </div>
                <div class="form-floating mb-3">
                    <h6>Kategori</h6>
